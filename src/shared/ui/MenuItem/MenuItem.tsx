...
interface MenuItemProps {
    variant: "chats" | "services" | "settings" | "contacts"
}
...
const MenuItem = (props: MenuItemProps) => {
    ...
    const config = {
        ...
        services: {
            text: "Сервисы",
            path: "/services",
            icon: (<svg width="20" height="20" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.27539 16L2.77539 11.7603M2.77539 11.7603L6.33906 1.68776C6.6635 0.770747 7.88728 0.770748 8.21172 1.68776L11.7754 11.7603M2.77539 11.7603H11.7754M11.7754 11.7603L13.2754 16" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
            </svg>)
        },
        contacts: {
            text: "Контакты",
            ...
            icon: (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM5.35 16.5C6.66 15.56 8.26 15 10 15C11.74 15 13.34 15.56 14.65 16.5C13.34 17.44 11.74 18 10 18C8.26 18 6.66 17.44 5.35 16.5ZM16.14 15.12C14.45 13.8 12.32 13 10 13C7.68 13 5.55 13.8 3.86 15.12C2.7 13.73 2 11.95 2 10C2 5.58 5.58 2 10 2C14.42 2 18 5.58 18 10C18 11.95 17.3 13.73 16.14 15.12Z" fill="currentColor" />
                <path d="M10 4C8.07 4 6.5 5.57 6.5 7.5C6.5 9.43 8.07 11 10 11C11.93 11 13.5 9.43 13.5 7.5C13.5 5.57 11.93 4 10 4ZM10 9C9.17 9 8.5 8.33 8.5 7.5C8.5 6.67 9.17 6 10 6C10.83 6 11.5 6.67 11.5 7.5C11.5 8.33 10.83 9 10 9Z" fill="currentColor" />
            </svg>)
        },
        settings: {
            text: "Настройки",
    ...
    const textColor = isActive ? "text-primary" : "text-gray";

    return (
        <li className="h-10 w-20">
            <Link href={item.path} className="flex flex-col justify-center items-center h-full w-full cursor-pointer">
                <span className={textColor}>
                    {item.icon}
                </span>
                <p className={`text-sm font-normal leading-[120%] ${textColor}`}>
                    {item.text}
                </p>
            </Link>
        </li>
